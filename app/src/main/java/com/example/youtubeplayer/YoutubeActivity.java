...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String GOOGLE_API_KEY="AIzaSyB0aVunKtL6bj7Aou6XaXLen1A-vfQClMw";
    static final String YOUTUBE_VIDEO_ID="jG7dSXcfVqE";
    static final String YOUTUBE_PLAYLIST="jG7dSXcfVqE";
